...
Partial Public Class accountDataSet
    ...
    Partial Public Class accountDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddaccountRow(ByVal name As String, ByVal uname As String, ByVal pass As String) As accountRow
            Dim rowaccountRow As accountRow = CType(Me.NewRow,accountRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, name, uname, pass}
...
Namespace accountDataSetTableAdapters
    ...
    Partial Public Class accountTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `account` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `account` (`name`, `uname`, `pass`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `account` SET `name` = ?, `uname` = ?, `pass` = ? WHERE ((`ID` = ?) AND (("& _ 
                "? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `uname` IS NULL) OR ("& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.RTSoft_Solutions.My.MySettings.Default.accountConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, name, uname, pass FROM account"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As accountDataSet.accountDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As accountDataSet.accountDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As accountDataSet.accountDataTable = New accountDataSet.accountDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As accountDataSet.accountDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_name As String, ByVal Original_uname As String, ByVal Original_pass As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal name As String, ByVal uname As String, ByVal pass As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal uname As String, ByVal pass As String, ByVal Original_ID As Integer, ByVal Original_name As String, ByVal Original_uname As String, ByVal Original_pass As String) As Integer
            If (name Is Nothing) Then
